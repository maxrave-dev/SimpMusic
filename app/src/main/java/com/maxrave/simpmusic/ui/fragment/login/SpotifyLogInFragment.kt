...
import com.maxrave.simpmusic.viewModel.SpotifyLogInViewModel
...
class SpotifyLogInFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding =
            FragmentSpotifyLogInBinding.inflate(inflater, container, false)
        return binding.root
    }
        ...
        binding.webView.apply {
            webViewClient = object : WebViewClient() {
                ...
                override fun onPageFinished(view: WebView?, url: String?) {
                    if (url?.contains(Config.SPOTIFY_URL) == true) {
                        ...
                        viewModel.status.observe(this@SpotifyLogInFragment) {
                            if (it) {
