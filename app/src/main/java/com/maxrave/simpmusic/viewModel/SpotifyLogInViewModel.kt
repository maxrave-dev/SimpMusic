...
@HiltViewModel
class SpotifyLogInViewModel @Inject constructor(private val dataStore: DataStoreManager) : ViewModel() {
    ...
    fun saveCookie(cookie: String) {
        viewModelScope.launch {
            ...
            dataStore.setSpotifyCookie(cookie)
            dataStore.setSpotifyLoggedIn(true)
