...
android {
    ...
    defaultConfig {
        ...
        if (isFullBuild) {
            ...
            // Ensure BuildConfig.SENTRY_DSN is always present (some sources reference it unconditionally).
            buildConfigField("String", "SENTRY_DSN", "\"\"")
        }
    }
...
dependencies {
    ...
    // Wear Data Layer (receive login requests from watch and relay cookie back).
