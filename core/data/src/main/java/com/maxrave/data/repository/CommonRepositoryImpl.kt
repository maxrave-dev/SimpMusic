...
internal class CommonRepositoryImpl(
    ...
    override fun init(dataStoreManager: DataStoreManager) {
        ...
        coroutineScope.launch {
                ...
                launch {
                    ...
                    combine(
                        ...
                        if (usingProxy) {
                            ...
                            // Avoid tearing down/recreating HTTP clients on startup when proxy is already disabled.
                            // Rebuilding the client while requests are launching can surface as
            ...
            val streamProxyFallbackJob =
                launch {
                    dataStoreManager.streamProxyFallback.distinctUntilChanged().collectLatest { enabled ->
                        youTube.setProxyFallbackEnabled(enabled == DataStoreManager.TRUE)
                    }
                }
            val dataSyncIdJob =
                launch {
