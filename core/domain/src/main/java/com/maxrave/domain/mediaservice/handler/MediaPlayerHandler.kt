...
interface MediaPlayerHandler {
    ...
    var onPlayerRefChanged: ((Any) -> Unit)? // Callback quand l'instance du player change (Crossfade) - Any car Player n'existe pas en commonMain
    ...
    // DJ Crossfade functionality
    fun startTrueDJCrossfade(nextMediaItem: GenericMediaItem, crossfadeDurationMs: Long)
