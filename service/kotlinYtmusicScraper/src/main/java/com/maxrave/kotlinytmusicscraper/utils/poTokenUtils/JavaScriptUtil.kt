...
/**
 * Utility class for JavaScript interactions from the PoTokenGenerator
 */
object JavaScriptUtil {
    ...
    /**
     * Builds an exception based on a JavaScript error message.
     */
    fun buildExceptionForJsError(error: String): Exception = PoTokenException("JavaScript error: $error")
